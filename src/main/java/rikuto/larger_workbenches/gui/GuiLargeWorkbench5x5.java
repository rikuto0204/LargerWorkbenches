...
public class GuiLargeWorkbench5x5 extends GuiContainer {
	...
	public GuiLargeWorkbench5x5(InventoryPlayer inventoryPlayer, World world, int x, int y, int z, TileEntityLargeWorkbench5x5 tileEntity) {
		super(new ContainerLargeWorkbench5x5(inventoryPlayer, world, x, y, z, tileEntity));
		xSize = 176;
		ySize = 202;
	}
