...
public class GuiLargeWorkbench4x4 extends GuiContainer {
	...
	public GuiLargeWorkbench4x4(InventoryPlayer inventoryPlayer, World world, BlockPos pos, TileEntityLargeWorkbench4x4 tileEntity) {
		super(new ContainerLargeWorkbench4x4(inventoryPlayer, world, pos, tileEntity));
		xSize = 176;
		ySize = 184;
	}
