...
public class GuiLargeWorkbench7x7 extends GuiContainer {
	...
	public GuiLargeWorkbench7x7(InventoryPlayer inventoryPlayer, World world, BlockPos pos, TileEntityLargeWorkbench7x7 tileEntity) {
		super(new ContainerLargeWorkbench7x7(inventoryPlayer, world, pos, tileEntity));
		xSize = 212;
		ySize = 238;
	}
