...
public class GuiLargeWorkbench8x8 extends GuiContainer {
	...
	public GuiLargeWorkbench8x8(InventoryPlayer inventoryPlayer, World world, BlockPos pos, TileEntityLargeWorkbench8x8 tileEntity) {
		super(new ContainerLargeWorkbench8x8(inventoryPlayer, world, pos, tileEntity));
		xSize = 230;
		ySize = 256;
	}
