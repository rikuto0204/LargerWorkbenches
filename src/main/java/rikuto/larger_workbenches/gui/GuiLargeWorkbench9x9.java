...
public class GuiLargeWorkbench9x9 extends GuiContainer {
	...
	public GuiLargeWorkbench9x9(InventoryPlayer inventoryPlayer, World world, BlockPos pos, TileEntityLargeWorkbench9x9 tileEntity) {
		super(new ContainerLargeWorkbench9x9(inventoryPlayer, world, pos, tileEntity));
		xSize = 240;
		ySize = 256;
	}
