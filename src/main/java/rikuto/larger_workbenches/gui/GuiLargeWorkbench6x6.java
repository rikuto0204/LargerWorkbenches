...
public class GuiLargeWorkbench6x6 extends GuiContainer {
	...
	public GuiLargeWorkbench6x6(InventoryPlayer inventoryPlayer, World world, int x, int y, int z, TileEntityLargeWorkbench6x6 tileEntity) {
		super(new ContainerLargeWorkbench6x6(inventoryPlayer, world, x, y, z, tileEntity));
		xSize = 194;
		ySize = 220;
	}
